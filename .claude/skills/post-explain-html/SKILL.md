---
name: post-explain-html
description: Use when the user asks for a rich explanation of a code change, diff, branch, or PR. Produces a single self-contained, interactive HTML explanation.
---
